...
export default function DetalleReparacionPage() {
  ...
  async function cambiarEstado() {
    ...
    const equipoNombre =
      equipo.categoria + (equipo.marca ? " " + equipo.marca : "");
    if (tel) {
      let msg = "";
      ...
      if (msg) {
        ...
        window.open(
          "https://wa.me/549" + telLimpio + "?text=" + encodeURIComponent(msg),
          "_blank",
        );
      }
    }
    ...
    <div className="p-4 max-w-2xl mx-auto pb-16">
      ...
      <div className="bg-white border rounded-xl p-4 mb-3">
        ...
        {equipo.clientes?.telefono && (
          <a
            href={
              "https://wa.me/549" + equipo.clientes.telefono.replace(/\D/g, "")
            }
            target="_blank"
      ...
      <div className="bg-white border rounded-xl p-4 mb-3">
          ...
          {equipo.presupuesto && (
            <div className="bg-yellow-50 rounded-lg px-3 py-2 text-center">
              ...
              <p className="font-bold text-yellow-700">
                ${Number(equipo.presupuesto).toLocaleString("es-AR")}
              </p>
            </div>
          )}
          {totalRepuestos > 0 && (
        ...
        <div className="flex gap-2 mt-3 flex-wrap">
          ...
          {equipo.estado === "listo_para_retirar" && !equipo.precio_final && (
            <button
              onClick={() => setMostrarPrecioFinal(true)}
        ...
        {mostrarRepuesto && (
          <div className="mb-3 p-3 bg-gray-50 rounded-lg space-y-2">
            <input
              ...
              onChange={(e) =>
                setNuevoRepuesto((r) => ({ ...r, descripcion: e.target.value }))
              }
            ...
            <div className="grid grid-cols-3 gap-2">
              <input
                ...
                onChange={(e) =>
                  setNuevoRepuesto((r) => ({ ...r, costo: e.target.value }))
                }
              ...
              <input
                ...
                value={nuevoRepuesto.precio_cobrado}
                onChange={(e) =>
                  setNuevoRepuesto((r) => ({
                    ...r,
              ...
              <input
                ...
                onChange={(e) =>
                  setNuevoRepuesto((r) => ({ ...r, cantidad: e.target.value }))
                }
                className="border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
              />
            </div>
              ...
              >
                <div>
                  ...
                  <div className="text-xs text-gray-400">
                    Costo: ${Number(r.costo).toLocaleString("es-AR")} · Cobrado:
                    ${Number(r.precio_cobrado).toLocaleString("es-AR")}
                  </div>
                </div>
                <button
